...
try:
    ...
    # Filtrar las líneas que contienen "Dulcinea"
    lineas_dulcinea = [linea for linea in lineas if "Dulcinea" in linea]

    # Crear el archivo dulcinea.txt y escribir las líneas filtradas
    with open("datos/dulcinea.txt", "w", encoding="utf-8") as salida:
        salida.writelines(lineas_dulcinea)

    print("✔ Archivo dulcinea.txt creado correctamente.")
