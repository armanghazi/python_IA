...
# hacemos pruebas con las primeras 200 líneas del libro
...
def buscar_lineas(subcadena, lineas):
    for linea in lineas:
        if subcadena.lower() in linea.lower():
            yield linea

# Usar el generador con las primeras 200 líneas del Quijote
for linea in buscar_lineas("Quijote", primeras_lineas):
    print(linea.strip())
